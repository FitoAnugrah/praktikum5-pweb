                        ...
                        <form action="/matkul" method="POST">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="kode" class="form-control border-start-0 ps-0 @error('kode') is-invalid @enderror" value="{{ old('kode') }}" placeholder="Contoh: IF101">
                                </div>
                                @error('kode')
                            ...
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="nama" class="form-control border-start-0 ps-0" required placeholder="Contoh: Basis Data Lanjut">
                                </div>
                            </div>
                            ...
                            <div class="mb-5">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="jurusan" class="form-control border-start-0 ps-0" required placeholder="Contoh: Teknik Informatika">
                                </div>
                            </div>
                            ...
                            <div class="d-flex gap-3">
                                ...
                                <button type="submit" class="btn btn-simpan btn-custom w-50 shadow">
